...
const RENDER_UI_PARAMETERS = {
	type: "object",
	properties: { spec: { description: "GenUI component tree (white-listed vocabulary, see the dsh-ui fence section in the system prompt). Deep-validated and repaired by the renderer." } },
	required: ["spec"],
...
function apply(ctx) {
	...
	if (tools !== void 0) tools.register(createRenderUiTool());
}
//#endregion
