...
export function GenuiPanel({ sessionId, sendGenuiAction }) {
    ...
    if (spec === null || spec.items.length === 0)
        return null;
    return (_jsx("div", { className: css.panel, "data-genui-panel": true, children: _jsx(GenuiActionContext.Provider, { value: sendGenuiAction, children: _jsx(GenuiBlock, { spec: spec }) }) }));
}
