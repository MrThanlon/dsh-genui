...
import { toolStateKey } from "./interaction-store.js";
...
export function GenuiToolView({ toolName, block, sessionId }) {
    ...
    return (_jsx("div", { className: css.tool, "data-genui-tool": true, children: _jsx(ErrorBoundary, { label: "\u5DE5\u5177\u5361\u7247", children: _jsx(GenuiBlock, { spec: spec, stateKey: toolStateKey(sessionId, block.callId) }) }) }));
}
