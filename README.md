...
[![GenUI 演示录屏（60 秒，点击播放）](./assets/demo-thumb.png)](./assets/demo.mp4)

> 点上面的图，会在 GitHub 的内置播放器里播放完整录屏（60 秒）；也可以直接 [下载 demo.mp4](./assets/demo.mp4)。想让模型自己把每种能力都展示一遍？[demo-prompts.md](./demo-prompts.md) 里有现成的四幕演示脚本，照着发就行。
