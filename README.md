...
![GenUI 演示录屏（60 秒）](./assets/demo.mp4)

> 如果上面没有出现播放器（某些环境对 README 内嵌视频支持有限），[点这里下载 demo.mp4](./assets/demo.mp4) 看。想让模型自己把每种能力都展示一遍？[demo-prompts.md](./demo-prompts.md) 里有现成的四幕演示脚本，照着发就行。
