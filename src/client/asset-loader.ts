 ...
 * (`/plugins/@dsh-external/dsh-genui/assets/*`), registered through the host
 ...
 * @module @dsh-external/dsh-genui/client/asset-loader
 */

/** The plugin's entry id — mirrors the loader entry name (package name). */
const PLUGIN_ID = '@dsh-external/dsh-genui'
